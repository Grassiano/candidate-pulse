...
export function TopNav() {
  ...
  return (
    <nav className="bg-(--color-card) border-b border-(--color-border) py-[14px]">
      <div className="max-w-[1240px] mx-auto px-8 flex items-center gap-6">
        <div className="flex items-center gap-[10px] shrink-0">
          <div
            className="w-[22px] h-[22px] rounded-full bg-(--color-mint)"
            style={{ boxShadow: "inset 0 -2px 0 rgba(0,0,0,0.04)" }}
          />
          <a
            href="/"
            className="latin font-semibold text-[17px] tracking-[-0.01em] text-(--color-ink)"
          >
            Candidate Pulse
          </a>
        </div>
        ...
        <div className="flex items-center gap-[14px] shrink-0">
          <div className="flex bg-[#F2F2F4] rounded-full p-[3px] text-[13px] font-medium">
            <button
              onClick={() => setLang("he")}
              className={`px-3 py-[5px] rounded-full leading-none inline-flex items-center transition ${
                lang === "he"
            ...
            <button
              onClick={() => setLang("en")}
              className={`latin px-3 py-[5px] rounded-full leading-none inline-flex items-center transition text-[12px] tracking-[0.02em] ${
                lang === "en"
                  ? "bg-white text-(--color-ink) shadow-[0_1px_2px_rgba(0,0,0,0.05)]"
                  : "text-(--color-muted)"
              }`}
          ...
          <button
            ...
            className="w-9 h-9 rounded-full border border-(--color-border) bg-white inline-flex items-center justify-center text-(--color-ink) relative"
          >
            <BellIcon size={16} />
            <span
